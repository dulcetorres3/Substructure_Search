...
@pytest.mark.parametrize(
    ...
    [
        pytest.param("../test_compounds/benzofuran.sdf", "../test_compounds/benzene.sdf", True, id="hit"),
        pytest.param("../test_compounds/benzofuran.sdf", "../test_compounds/methyl.sdf", False, id="no_hit"),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param("../test_compounds/benzofuran.sdf", "../test_compounds/benzofuran.sdf", True, id="equal"),
        pytest.param("../test_compounds/benzofuran.sdf", "../test_compounds/benzene.sdf", False, id="not_equal"),
    ],
) 
